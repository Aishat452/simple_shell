...
/**
 * get_len - Gets length of numbers.
 * @n: int type of number.
 * Return: returns the length of numbers.
 */
int get_len(int n)
{
...
/**
 * aux_itoa - the function that converts int to string.
...
/**
 * _atoi - convert's string into integer.
